...
ggplot(WideSales, aes(x=Period, y=ZSales.Japan_distance, group =1)) + geom_line()+theme(axis.text.x = element_text(angle = 90, hjust = 1))+ylim(-3, 3)
```
...
### PR1: (11) Visualisierung NF Japan 
